...
<template>
    <f7-page color-theme="pink">
        ...
        <f7-navbar title="Empresa" back-link="Back"></f7-navbar>
...
<h2>Visão</h2>
<p>“Ser reconhecida como uma das melhores docerias da região pelo seu atendimento e qualidade dos produtos oferecidos”.</p>
<h2>Valores</h2>
<ul>
<li>Agilidade</li>
<li>Dedicação</li>
